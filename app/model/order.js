...
var Order = {
	...
	getOrderByUserId: function(id, callback){
		var sql = "SELECT * FROM orders JOIN order_product ON orders.id = order_product.id_order JOIN product ON order_product.id_product = product.id WHERE orders.id_user=$1";
		return connection.query(sql, [id], callback);
	},
